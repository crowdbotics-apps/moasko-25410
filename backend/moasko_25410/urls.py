"""moasko_25410 URL Configuration
...
admin.site.site_header = "moasko"
admin.site.site_title = "moasko Admin Portal"
admin.site.index_title = "moasko Admin"

# swagger
api_info = openapi.Info(
    title="moasko API",
    default_version="v1",
    description="API documentation for moasko App",
)
